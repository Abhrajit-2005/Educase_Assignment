  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white gap-6">
          ...
          <div className="relative flex flex-col justify-between h-full">
            ...
            <div className=" flex flex-col items-start justify-end text-center h-[70vh] ">
              ...
              <div className="space-y-3">
                <button onClick={signup} className=" w-full py-3 rounded-md bg-violet-600 hover:bg-violet-700 text-white font-semibold transition cursor-pointer">
                  Create Account
                </button>
        ...
        {page === 4 && (
          <div className="text-left">
            ...
            <div className="bg-gray-100 p-4 rounded-md flex items-center gap-4 mb-4">
              ...
              />
              <div>
                <p className="font-bold text-gray-800">Abhrajit Chatterjee</p>
                <p className="text-gray-600 text-sm">abhrajitc23@gmail.com</p>
              </div>
            </div>
      ...
      <div className="flex items-center justify-center gap-6 pt-4  w-[370px]">
        ...
        <button onClick={home} className="text-gray-500 hover:text-gray-700 cursor-pointer">
          <svg
